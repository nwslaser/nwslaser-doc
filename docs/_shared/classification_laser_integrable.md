...
<div class="image-texte-cadre">
    ...
    <p>
        <strong>Danger général :</strong> Le dispositif laser IK-SERIES est destiné à être intégré dans des machines ou à être assemblé avec d'autres équipements pour constituer une machine de traitement laser à l'intérieur d'un boîtier de sécurité et connecté à d'autres appareils électriques.
